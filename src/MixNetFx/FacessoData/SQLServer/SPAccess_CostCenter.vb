...
Partial Public NotInheritable Class SPAccess
    ...
    ''' <summary>
    ''' �berpr�ft, ob die angegebene Kostenstelle f�r die Subsidiary schon existiert.
    ''' </summary>
    ...
    ''' <summary>
    ''' F�gt die in CostcenterInfo gespeicherte Kostenstelle der Datenbank hinzu.
    ''' </summary>
    ''' <param name="cci">CostcenterInfo mit den Daten f�r die Kostenstelle.</param>
    ''' <returns>ErrCode von der Datenbank.</returns>
    ''' <remarks>Die korrelierende Stored Procedure handelt die Versionskontrolle und schlie�t doppelte Kostenstellennr. aus.</remarks>
