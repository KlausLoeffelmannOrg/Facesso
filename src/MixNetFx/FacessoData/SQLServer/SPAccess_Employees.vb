    ...
    Friend Sub Employees_LookUpWageData(ByVal Employee As EmployeeWageInfo)
        ...
        Using locConnection
            ...
            Catch ex As Exception
                MessageBox.Show("Basislohn f�r Mitarbeiter " & Employee.LastName & " (" & Employee.PersonnelNumber.ToString & _
                ") wurde nicht richtig zugeordnet." & vbNewLine & _
                "Bitte �berpr�fen Sie daher die durchgef�hrten Berechnungen f�r die Facesso keine Richtigkeit garantieren kann!", _
