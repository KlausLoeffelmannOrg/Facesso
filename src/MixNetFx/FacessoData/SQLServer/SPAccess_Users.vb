...
Partial Public NotInheritable Class SPAccess
    ...
    ''' <summary>
    ''' �berpr�ft, ob der angegebene Benutzername f�r die Subsidiary schon existiert.
    ''' </summary>
    ...
    ''' <summary>
    ''' F�gt den in UserInfo und AddressDetails gespeicherten Benutzer der Datenbank hinzu.
    ''' </summary>
    ''' <param name="ui">UserInfo mit den Hauptdaten f�r den Benutzer.</param>
    ''' <param name="addrDet">AddressDetailsInfo mit den Adressendaten f�r den Benutzer.</param>
    ''' <returns>Neue ID des Users.</returns>
    ''' <remarks>Die korrelierende Stored Procedure handelt die Versionskontrolle und schlie�t doppelte Benutzernamen aus.</remarks>
