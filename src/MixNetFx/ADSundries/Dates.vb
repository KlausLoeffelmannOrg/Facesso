...
Public NotInheritable Class Dates
    ...
    Public Shared Function NextWorkday(ByVal CurrentDate As Date, ByVal WorkOnSaturdays As Boolean, ByVal WorkOnSundays As Boolean) As Date
        ...
        If (Weekday(CurrentDate, FirstDayOfWeek.System) = DayOfWeek.Saturday) And (Not WorkOnSaturdays) Then
            CurrentDate = CurrentDate.AddDays(1)
        End If
        If (Weekday(CurrentDate, FirstDayOfWeek.System) = 7) And (Not WorkOnSundays) Then
            CurrentDate = CurrentDate.AddDays(1)
        End If
        Return CurrentDate
    End Function
