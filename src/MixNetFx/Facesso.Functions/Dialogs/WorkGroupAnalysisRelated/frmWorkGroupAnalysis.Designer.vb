...
Partial Public Class frmWorkGroupAnalysis
    ...
    Private Sub InitializeComponent()
        ...
        Me.drpMain = New Facesso.GenericControls.ucAnalysisDateRangePicker
        ...
        Me.Label3.Text = "Dieser Assistent hilft Ihnen, die erforderlichen Parameter zusammenzustellen, um " & _
            "auf m�glichst flexible Art und Weise Auswertungen von Produktiv-Sites durchf�hre" & _
            "n zu k�nnen."
        '
        'Label2
        '
        ...
        Me.Label13.Text = "W�hlen Sie diesen Schichttyp, wenn Mitarbeiter beispielsweise in der ersten Woche" & _
        ...
        Me.Label14.Text = "Beschreibung f�r das ausgew�hlte Element:"
        ...
        Me.optCSVExport.Text = "CSV-Export f�r die Excel-Weiterverarbeitung (nur Enterprise-Edition!)"
        ...
        Me.Label11.Text = "Hinweis: Diese Einstellung findet nur in der Enterprise-Edition Ber�cksichtigung " & _
            "und gilt ausschlie�lich f�r den Excel-Datenexport!"
        '
        'Label20
        '
        ...
        Me.Label15.Text = "�berpr�fen Sie die Einstellungen in der folgenden Zusammenfassung:"
        '
        'Label35
        '
        ...
        Me.Label35.Text = "Klicken Sie schlie�lich auf [Fertig], um die Auswertung zu erstellen."
        '
        'Label34
        '
        ...
        Me.Text = "Assistent zur Durchf�hrung von Produktiv-Sites-Analysen"
    ...
    Friend WithEvents drpMain As Facesso.GenericControls.ucAnalysisDateRangePicker
