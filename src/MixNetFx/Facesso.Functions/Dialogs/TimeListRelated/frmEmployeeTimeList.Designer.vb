...
Partial Class frmEmployeeTimeList
    ...
    Private Sub InitializeComponent()
        ...
        Me.dgvTimeList = New Facesso.GenericControls.ucTimeLogItemsDataGridView
    ...
    Friend WithEvents dgvTimeList As Facesso.GenericControls.ucTimeLogItemsDataGridView
