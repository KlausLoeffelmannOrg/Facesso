...
Partial Public Class frmOptions
    ...
    Private Sub InitializeComponent()
        ...
        Me.UcTimeDetailsSettings = New Facesso.GenericControls.ucTimeDetailsSettings
        ...
        Me.Label6.Text = "HINWEIS: Aktivieren Sie dieses Kontrollk�stchen, wenn die ""Daten-vorhanden-Anzeig" & _
        ...
        Me.Label2.Text = "HINWEIS: Diese Einstellungen beziehen sich ausschlie�lich auf das 'Bl�ttern' des " & _
        ...
        Me.Label13.Text = "Hinweis: Die Anzahl dargestellter Stellen der Leistungsindikatoren ergibt sich au" & _
            "s der in den jeweiligen Kostenstellen hinterlegten Pr�zisionsdefinition."
        '
        'Label12
        '
        ...
        Me.Label14.Text = "Hinweis: Wird proportional auf 1,5 cm-H�he verkleinert bzw. vergr��ert."
        '
        'btnLogo
        '
        ...
        Me.Label9.Text = "Text- und Tabellenk�rper:"
        '
        'btnTableHeaderFont
        '
        ...
        Me.Label5.Text = "�berschrift Ebene &3:"
        '
        'btnU2Font
        '
        ...
        Me.Label3.Text = "�berschrift Ebene &2:"
        '
        'btnU1Font
        '
        ...
        Me.Label1.Text = "�berschrift Ebene 1:"
        '
        'tpThresholdValues
        '
        ...
        Me.tpThresholdValues.Text = "Daten�bernahme-Optionen"
        ...
        Me.GroupBox7.Text = "Fallback-Times (f�r die Schichtzuweisung von Zeit�bernahmedaten)"
        '
        ...
        Me.nibThresholdFirstShift.NullValueMessage = "Bitte geben Sie einen Wert f�r die Schwelle zur ersten Schicht in Minuten ein."
        ...
        Me.Label8.Text = "HINWEIS: Diese Werte bestimmen Sie f�r die Unter-/Obergrenze der ersten Schicht, " & _
            "damit beim Rauslaufen von �bernahmedaten aus einem Schichtmodell eine Zuweisung " & _
            "dennoch m�glich wird."
        '
        'dtbFallBackTimeEnd
        '
        ...
        Me.GroupBox8.Text = "Optionen bei der Zeiten�bernahme:"
        '
        ...
        Me.chkShowTimeLogPriorToImport.Text = "Ergebnistabelle vor der �bernahme anzeigen"
        ...
        Me.chkShowIssueListPriorToImport.Text = "Fehlerliste vor der �bernahme anzeigen"
        ...
        Me.Label15.Text = "HINWEIS: Diese Einstellungen beziehen sich nur auf die �bernahme von Zeitdaten au" & _
    ...
    Friend WithEvents UcTimeDetailsSettings As Facesso.GenericControls.ucTimeDetailsSettings
