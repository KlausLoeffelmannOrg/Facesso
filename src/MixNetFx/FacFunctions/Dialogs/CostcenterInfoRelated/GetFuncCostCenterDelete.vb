...
Public Class GetFuncCostCenterDelete
    ...
    Public Overrides ReadOnly Property RolePermissionViolationMessage() As String
        Get
            Return My.Resources.CostCenterInfoDelete_DeniedDueToRole
        End Get
    End Property
    ...
    Public Function DeleteItem(ByVal InfoItem As IInfoItem) As Boolean
        Dim locCostCenterInfo As CostcenterInfo = DirectCast(InfoItem, CostcenterInfo)
        If SPAccess.GetInstance.CostCenters_IsInUse(locCostCenterInfo) Then
            MessageBox.Show("Da diese Kostenstelle bereits in Verwendung ist," & vbNewLine & _
                            "kann sie nicht gelöscht werden.", "Bereits in Verwendung!", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Function
        End If

        Dim locDr As DialogResult = MessageBox.Show("Sind Sie sicher, die Kostenstelle" & vbNewLine & vbNewLine & _
                                                  locCostCenterInfo.DisplayName & vbNewLine & vbNewLine & _
        ...
        If locDr = DialogResult.Yes Then
            ...
            Catch ex As Exception
                MessageBox.Show("Beim Löschen der Kostenstelle ist ein Fehler aufgetreten!" & _
