...
Public Class GetFuncEmployeeDelete
    ...
    Public Overrides ReadOnly Property RolePermissionViolationMessage() As String
        Get
            Return My.Resources.EmployeeInfoDelete_DeniedDueToRole
        End Get
    End Property
    ...
    Public Function DeleteItem(ByVal InfoItem As IInfoItem) As Boolean
        Dim locEmployeeInfo As EmployeeInfo = DirectCast(InfoItem, EmployeeInfo)
        If SPAccess.GetInstance.Employees_IsInUse(locEmployeeInfo) Then
            MessageBox.Show("Da es zu diesem Mitarbeiter bereits Daten gibt," & vbNewLine & _
                            "kann er nicht gelöscht werden.", "Bereits in Verwendung!", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Function
        End If

        Dim locDr As DialogResult = MessageBox.Show("Sind Sie sicher, den Mitarbeiter" & vbNewLine & vbNewLine & _
                                                  locEmployeeInfo.DisplayName & vbNewLine & vbNewLine & _
        ...
        If locDr = DialogResult.Yes Then
            ...
            Catch ex As Exception
                MessageBox.Show("Beim Löschen des Mitarbeiters ist ein Fehler aufgetreten!" & _
