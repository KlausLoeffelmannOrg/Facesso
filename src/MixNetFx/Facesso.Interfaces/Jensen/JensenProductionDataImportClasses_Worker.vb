...
Partial Class JensenProductionDataImportTaskElement
    ...
    Private Sub retrieveDataForDate(ByVal ProductionDate As Date)
        ...
        If exCollection <> "" Then
            ...
            Catch ex As Exception
                System.Windows.Forms.MessageBox.Show("Beim Versuch, das Ausnahmebehandlungsprotokoll f�r den Jensen-Import zu schreiben, ist ein Fehler aufgetreten!" & vbNewLine & vbNewLine &
