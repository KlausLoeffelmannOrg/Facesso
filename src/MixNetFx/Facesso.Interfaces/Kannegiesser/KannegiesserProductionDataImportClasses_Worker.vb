...
Partial Class KannegiesserProductionDataImportTaskElement
    ...
    Private Sub retrieveDataForDate(ByVal ProductionDate As Date)
        ...
        Using locConnection
            ...
            locAdapter.SelectCommand.Parameters.AddWithValue("@DATUM", ProductionDate.Date)
            'Falls das eine Exception wirft, dann den BDE (Paradox-Treiber) installieren.
            'Der ist nicht mehr erh�ltlich, hei�t bde.exe ist im Install-Verzeichnis auf
            'dem Server, ca. 5 MByte gro�.
