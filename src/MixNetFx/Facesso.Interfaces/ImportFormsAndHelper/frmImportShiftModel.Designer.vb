...
Partial Class frmImportShiftModel
    ...
    Private Sub InitializeComponent()
        Me.UcTimeDetailsSettings1 = New Facesso.GenericControls.ucTimeDetailsSettings
    ...
    End Sub
    Friend WithEvents UcTimeDetailsSettings1 As Facesso.GenericControls.ucTimeDetailsSettings
