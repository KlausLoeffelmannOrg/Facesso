...
Partial Class frmProductionDataConfigureDialogBase
    ...
    Private Sub InitializeComponent()
        ...
        Me.ucLabourValues = New Facesso.GenericControls.ucLabourValueListView()
        ...
        Me.lblTitel.Text = "Konfiguration f�r Produktiv-Site:"
        ...
        Me.ucLabourValues.LabourValueSortOrder = Facesso.GenericControls.LabourValuesSortOrder.LabourValueNumber
        ...
        Me.GroupBox2.Text = "Ger�te-Elemente (Artikel, Programmnr, etc.)"
        '
        'TableLayoutPanel2
        '
        ...
        Me.Text = "Konfiguration der Produktiv-Site f�r die Daten�bernahme"
    ...
    Protected Friend WithEvents ucLabourValues As Facesso.GenericControls.ucLabourValueListView
