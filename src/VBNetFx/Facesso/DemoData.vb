...
Public Class DemoProduct
    ...
    Public Shared Function RandomProducts(ByVal Kontakte As List(Of DemoContact)) As List(Of DemoProduct)

        Dim tmpRandom As New Random(42)
        Dim tmpListOfProducts As New List(Of DemoProduct)
...
Public Class DemoContact
    ...
    Public Shared Function RandomContacts(ByVal Count As Integer) As List(Of DemoContact)

        Dim tmpListOfAddresses As New List(Of DemoContact)
        Dim tmpRandom As New Random(42)
        ...
        For i As Integer = 1 To Count
            ...
            tmpListOfAddresses.Add(New DemoContact( _
                            i, _
                            tmpLastName, _
                            tmpFirstName, _
    ...
    Shared Sub PrintContacts(ByVal Contacts As List(Of DemoContact))
