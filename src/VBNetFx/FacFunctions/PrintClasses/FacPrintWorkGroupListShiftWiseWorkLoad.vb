...
Public Class FacPrintWorkGroupListShiftWiseWorkLoad
    ...
    Protected Overrides Sub PrepareDocument()
        ...
        With PrintDocument
            ...
            .BeginTable(BorderStyle, 65, 85, 150, 120, 145, 135, 90)
            .BuildTableHeader()
            .CurrentCellAlignment = ActiveDev.Printing.ADTextCellAlignment.TopCenter
            .WriteCells("Schicht", "Site-Nr.:", "Site-Name", "Unterbr.-" + vbNewLine + "zeiten", "Netto-" + vbNewLine + "zeiten", "Kennzahlen", "Auslastung")
            .BuildTableBody()
                ...
                For locShift As Integer = 1 To 4
                    ...
                    If locDoPrint And locItem IsNot Nothing Then
                        ...
                        .WriteCell("Zeitgrad: " & locItem.DegreeOfTime.ToString("##0") & vbNewLine & _
                                   "Zeitgrad (angp.): " & locItem.DegreeOfTimeAdj.ToString("##0"))
                        .CurrentCellAlignment = ActiveDev.Printing.ADTextCellAlignment.TopRight
                        .WriteCell(locAnalysisInfo.PercentageWorkload.ToString("#,##0.00 " & "%"))
