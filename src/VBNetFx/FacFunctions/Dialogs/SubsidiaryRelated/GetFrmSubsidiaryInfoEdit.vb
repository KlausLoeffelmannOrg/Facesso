...
Public Class GetFrmSubsidiaryInfoEdit
    ...
    Public Function ShowDialog(ByVal InfoItem As IInfoItem) As InfoItemMaintenanceDialogResult
        ...
        Dim locFrmSubsidiaryInfoEdit As New frmSubsidiaryInfoAddEditView
        Return locFrmSubsidiaryInfoEdit.Fac_HandleDialogAsEdit(My.Resources.SubsidiaryInfoEdit_FormCaption, InfoItem)
    End Function
End Class
