...
Partial Class ADDatabaseConnectionDialog
    Inherits ActiveDev.Data.SqlClient.ADSqlInstanceConnectionDialog
    ...
    Private Sub InitializeComponent()
        Me.SqlDatabaseConnector = New ActiveDev.Data.SqlClient.ADSqlDatabaseConnector
        Me.SuspendLayout()
        '
        'btnOK
        '
        ...
        '
        Me.SqlDatabaseConnector.CredentialMethod = ActiveDev.Data.SqlClient.SqlCredentialMethods.WindowsIntegratedSecurity
        Me.SqlDatabaseConnector.CredentialParameters = Nothing
        Me.SqlDatabaseConnector.DatabaseSource = ActiveDev.Data.SqlClient.SqlDatabaseSource.FromSqlServerInstance
    ...
    End Sub
    Friend WithEvents SqlDatabaseConnector As ActiveDev.Data.SqlClient.ADSqlDatabaseConnector
