...
{
    public class FacPrintWorkGroupListShiftWise : FacessoPrintBase
    {
        private WorkGroupAnalysisInfoItems myWorkGroupAnalysis;
        private ProductionPeriod myProductionPeriod;
        public FacPrintWorkGroupListShiftWise(WorkGroupAnalysisInfoItems WorkGroupAnalysis, ProductionPeriod Period, string Username) : base("Produktiv-Site-Auswertung", WorkGroupAnalysis.Period.RangeDescription, Username)
        {
        ...
        protected override void PrepareDocument()
        {
            ...
            double locTotalWorkingTime = default(double);
            {
                ...
                __with0.BeginTable(BorderStyle, 65, 85, 175, 120, 145, 135);
