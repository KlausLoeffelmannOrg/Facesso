...
{
    public class GetFrmWorkGroupInfoEdit : FacessoFunctionBase
    {
        ...
        public override string RolePermissionViolationMessage
        {
            get
            {
                return Facesso.Functions.My.Resources.WorkGroupInfoEdit_DeniedDueToRole;
            }
        }
        ...
        public InfoItemMaintenanceDialogResult ShowDialog(IInfoItem InfoItem)
        {
            ...
            frmWorkGroupInfoAddEditView locFrmWorkGroupInfoEdit = new frmWorkGroupInfoAddEditView();
            return locFrmWorkGroupInfoEdit.Fac_HandleDialogAsEdit(Facesso.Functions.My.Resources.WorkGroupInfoEdit_FormCaption, InfoItem);
        }
    }
}