...
Public Class frmEmployeeTimeList
    ...
    Public Overloads Sub ShowDialog(ByVal Employee As EmployeeInfo, ByVal ReferenceDate As Date)
        ...
        myEmployee = Employee
        Me.Text = "Zeitenliste f�r " & Employee.DisplayName
        InitializeDates()
    ...
    Private Sub dgvTimeList_TimeLogItemDoubleClick(ByVal sender As System.Object, ByVal e As Facesso.GenericControls.TimeLogItemClickEventArgs) Handles dgvTimeList.TimeLogItemDoubleClick
