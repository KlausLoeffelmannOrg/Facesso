...
Public Class frmProductionDataCollector
    ...
    Sub HandleDialog(ByVal CombinedParameters As CombinedParametersInfo)
        ...
        End If
        If locError <> "" Then
            MessageBox.Show("Datenerfassung ist noch nicht m�glich:" & vbNewLine & vbNewLine & _
                            locError & vbNewLine & _
                            "Bitte f�hren Sie zun�chst die Stammdaten erfassung durch!", _
            "Datenerfassung nicht m�glich", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Exit Sub
        End If
    ...
    Private Sub tsmEmployeeTime_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsmEmployeeTime.Click, tsbNewEmployeeTimes.Click
        ...
        Catch ex As Exception
            MessageBox.Show("Bitte �berpr�fen Sie Ihre Eingabe, da die Formelauswertung einen Syntax-Fehler generierte!", _
    ...
    Private Sub dgvTimeLogItems_TimeLogItemDoubleClick(ByVal sender As System.Object, ByVal e As Facesso.GenericControls.TimeLogItemClickEventArgs) Handles dgvTimeLogItems.TimeLogItemDoubleClick
    ...
    Private Sub SaveChanges(ByVal Rebuild As Boolean, ByVal SaveInAnycase As Boolean)
        ...
        Catch ex As SqlClient.SqlException
            If ex.Message.Contains("IDBonusLists") Then
                MessageBox.Show("Die zuletzt eingegebenen Mitarbeiter konnten nicht hinzugef�gt werden, da keine " & vbNewLine & _
                                "�ber die Kostenstelle zugewiesene individuelle Bonus-Tabelle existiert." & vbNewLine & vbNewLine & _
                                "Bitte legen Sie entweder eine Bonus-Tabelle f�r die dem Mitarbeiter zugewiesene" & vbNewLine & _
                                "Kostenstelle an, oder weisen Sie dem Mitarbeiter wieder die Systemkostenstelle zu!" & vbNewLine & vbNewLine & _
                                "Die zuletzt eingegebenen Mitarbeiter werden verworfen.", "Zeitenzuweisung konnte nicht ausgef�hrt werden!", _
    ...
    Private Sub tsbMyTodoList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbMyTodoList.Click, tsmMyTodoList.Click
        MessageBox.Show("Diese Funktion steht nur in der Enterprise-Edition zur Verf�gung", _
                "Funktion nicht verf�gbar!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
    End Sub
    ...
    Private Sub tsmDeleteShiftData_ButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsmDeleteShiftData.ButtonClick
        Dim locDr As DialogResult = MessageBox.Show("Sind Sie sicher, dass Sie die Produktionsdaten" & vbNewLine & _
                    "der aktuellen Schicht l�schen wollen?", "Produktionsdaten l�schen?", MessageBoxButtons.YesNo, _
