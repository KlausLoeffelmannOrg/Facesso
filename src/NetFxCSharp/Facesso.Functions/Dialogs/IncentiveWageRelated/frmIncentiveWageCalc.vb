Imports Facesso.GenericControls
...
Public Class frmIncentiveWageCalc
    ...
    Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
        ...
        If locEmployees Is Nothing OrElse locEmployees.Count = 0 Then
            MessageBox.Show("Es sind keine Stammdaten vorhanden. Bitte legen Sie zun�chst die erforderlichen Stammdaten an und f�hren Sie eine Datenerfassung durch", _
    ...
    Private Sub btnPerformCalculation_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPerformCalculation.Click
        ...
        If locCount = 0 Then
            MessageBox.Show("Bitte w�hlen Sie die auszuwertenden Mitarbeiter aus.", _
                            "Keine Mitarbeiter ausgew�hlt:", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Return
        End If
