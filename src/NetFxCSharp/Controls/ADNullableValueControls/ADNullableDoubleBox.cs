...
{
    public class ADNullableDoubleBox : ADNullableValueControlTemplate<double>
    {
        ...
        protected int myDecimalPlaces;
        protected bool myHasGroupSeperator;
        ...
        public ADNullableDoubleBox() : base()
        {
            ADDBNullable<double> locNullable = new ADDBNullable<double>();
        ...
        public string DisplayFormatString
        {
            get
            {
                ...
                else
                {
                    ...
                    if (myDecimalPlaces > 0)
                    {
                        locDFS += "." + new string ('0', myDecimalPlaces);
                    }
                    else if (myDecimalPlaces < 0)
                    {
                        locDFS += "." + new string ('#', myDecimalPlaces * -1);
                    }
        ...
        {
            return !((DisplayCustomFormatString == "#,##0.00 €"));
        }
        ...
        [ADDescription("Bestimmt oder ermittelt das/den Währungssymbol/-text.", "Gets or sets the the currency symbol/text.")]
        ...
        [RefreshProperties(RefreshProperties.Repaint)]
        [ADCategory("Darstellung", "Appearance")]
        [ADDescription("Bestimmt oder ermittelt die Anzahl der dargestellten Dezimalstellen. Ein negativer Wert bestimmt die Anzahl möglicher Nachkommastellen. Ein positiver Wert erzwingt das Auffüllen mit endenden Nullen.", "Gets or sets the number of decimal places to be shown. A negative Value sets the number of maximal possible digits to be shown. A positive value forces the filling up with zeros.")]
        [DefaultValue(-5)]
        public int DecimalPlaces
        {
            ...
            set
            {
                ...
                {
                    ArgumentOutOfRangeException up = new ArgumentOutOfRangeException("Value", "Der Wert, der die Anzahl der Dezimalstellen beschreibt, darf sich zwischen 0 und 30 befinden!");
                    throw up;
                }
        ...
        protected override ADDBNullable<double> ToNullableValue(object Object)
        {
            if (Object.ToString() == "" | Object == null)
            {
                return default(ActiveDev.ADDBNullable<double>);
            }
