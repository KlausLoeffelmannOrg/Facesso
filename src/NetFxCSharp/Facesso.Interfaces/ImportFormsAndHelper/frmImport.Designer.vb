...
Partial Class frmImport
    ...
    Private Sub InitializeComponent()
        ...
        Me.ucWorkGroups = New Facesso.GenericControls.ucWorkGroupListView
        ...
        Me.lblImportStatus.Text = "Status: W�hlen Sie den Datumsbereich und anschlie�end 'Import starten!'"
        ...
        Me.tsmEditDeleteImportTask.Text = "Import-Task l�schen..."
        '
        'btnOK
        '
        ...
        Me.ucWorkGroups.WorkGroupSortOrder = Facesso.GenericControls.WorkGroupSortOrder.WorkGroupNumber
        '
        'btnSelectAll
        '
        ...
        Me.lblWorkgroups.Text = "Zeitdaten f�r diese Produktiv-Sites �bernehmen:"
        '
        'frmImport
        '
    ...
    Friend WithEvents ucWorkGroups As Facesso.GenericControls.ucWorkGroupListView
